...
| 方案 | 來源/證據 | 狀態 |
|------|----------|------|
| SSH 入 VPS 檢查 Docker 狀態 | 用戶提出 (2026-01-13) | 待執行 |
| 檢查 Nginx 係咪監聽 80/443 | [!Uncertain: 需要 SSH 確認] | 待執行 |
| 檢查 SSL 證書係咪有效 | [!Uncertain: 需要 SSH 確認] | 待執行 |
| `nslookup test.aplus-tech.com.hk` 確認 DNS | [!Uncertain: 需要執行確認] | 待執行 |
